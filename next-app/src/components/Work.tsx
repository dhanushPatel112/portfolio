          ...
          <section className="text-black body-font bg-white">
            <div className="p-6 rounded-lg border-4 border-gray-700">
              ...
              <div className="flex flex-wrap -mx-4 -my-8">
                ...
                <div data-te-toggle="tooltip" title="NodeJS" className="py-0 px-4 lg:w-1/4 md:w-1/2">
                  <div className="h-full flex items-center justify-center">
              ...
              <div className="py-5">
                ...
                <div className="container px-5 mx-auto">
                  ...
                  <p className="leading-relaxed text-base">
                    A web app built with Next JS and MongoDB as Database serves users a platform to create ID cards with a drag and drop editor built-in. Also, they can choose a ready-made template
                    with various product variants such as RFID and 1k Mifare chip type, glossy and matt material type, etc. It provides the facility to preview how they would look and download it as a
                    PDF.
                  </p>
                  <div className="flex mt-4">
                    <div className="text-gray-400 inline-flex items-center ml-4">
                      ...
                      <em data-te-toggle="tooltip" title="MongoDB">
                        <svg height="40" width="40" viewBox="8.738 -5.03622834 17.45992422 39.40619484" xmlns="http://www.w3.org/2000/svg">
                          <path
