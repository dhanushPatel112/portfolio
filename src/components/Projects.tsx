...
import bookStoreImage from "/public/images/book_store.png"
import pataTapImage from "/public/images/pataTap.png"
import colorGameImage from "/public/images/colurGame.png"
                ...
                <div className="container mx-auto flex flex-wrap px-5 py-16 lg:flex-row md:flex-col items-center">
                    ...
                    <div className="lg:w-1/2 lg:pl-10 md:pl-8 flex flex-col md:items-start md:text-left items-center text-center lg:order-last md:order-first">
                        ...
                        <p className="mb-8 leading-relaxed">
                            A MERN stack web app platform used for purchasing and selling books. Web app consist of
                            Admin panel to manage and regulate the stock and Payment gateway with secure and encrypted
                            PayPal and Credit card Support. It has also search functionality with various filters.
                        </p>
                        <h2 className="text-indigo-500 font-bold">
                            Link:{" "}
                            <Link
                                href="https://github.com/spockpatel/Book-Store"
                                target="_blank"
            ...
            <section className="text-black bg-white body-font">
                <div className="container mx-auto flex flex-wrap px-5 py-16 lg:flex-row md:flex-col items-center">
                    <div className="lg:w-1/2 lg:pr-10 md:pr-8 flex flex-col md:items-start md:text-left items-center text-center">
                        ...
                        <p className="mb-8 leading-relaxed">
                            A fun single page website built using HTML, CSS and JavaScript with help of Canvas. It has
                            various musical notes on pressing keyboard keys with various different animations.
                        </p>
                        <h2 className="text-indigo-500 font-bold">
                            Link:{" "}
                            <Link
                                href="https://github.com/spockpatel/pataTap"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="underline"
                            >
            ...
            <section className="text-black bg-white body-font">
                <div className="container mx-auto flex flex-wrap px-5 py-16 lg:flex-row md:flex-col items-center">
                    ...
                    <div className="lg:w-1/2 lg:pl-10 md:pl-8 flex flex-col md:items-start md:text-left items-center text-center lg:order-last md:order-first">
                        ...
                        <p className="mb-8 leading-relaxed">
                            A nice responsive game in which one has to guess the hash code of color. It has different
                            difficulty levels and built using HTML, CSS and JS.
                        </p>
                        <h2 className="text-indigo-500 font-bold">
                            Link:{" "}
                            <Link
                                href="https://github.com/spockpatel/ColorGame"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="underline"
                            >
